...
public class ventanaDetalleConfirmacionCurso extends JDialog {
   ...
   nombreExpositor.setFont(new Font("Arial Black", Font.BOLD, 15));
	 ...
	 public static void main(String[] args) {
		String texto = "saaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa saaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaasdd ";
		new ventanaDetalleConfirmacionCurso("Denis Parra", "Generacion de Software", "14/02/2014 9:45 - 11:15"+"\n"+"14/02/2014 9:45 - 11:15", texto);
	}
