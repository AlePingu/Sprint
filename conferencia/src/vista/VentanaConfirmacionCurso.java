...
public static void main(String[] args) {
	String [] numero = {"1","2","3"};
	String [] expositor = {"Juan Quiroga Sanchez","Ana Maria Rivera","Jose Luis Reyes"};
	String [] curso = {"Generacion de Software","Seguridad de Datos","seguridad en Redes"};
	new VentanaConfirmacionCurso(numero, expositor, curso);
}
