...
public static void main(String[] args) {
	String cursos [] = {"generacion software","inteligencia artificial","redes"};
	String inscritos [] = {"1000","100","100"};
	String montoRecaudado [] = {"10000","500","400"};
	new detalleEconomicoCursos(cursos, inscritos, montoRecaudado);
}
}
