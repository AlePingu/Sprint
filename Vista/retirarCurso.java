...
public class retirarCurso extends JDialog{
	...
	public retirarCurso(String[] curso,String[] expositor,String [] ambiente,String[] fecha){
   ...
   quitarCurso.setBounds(50,500,150,25);
	...
	public static void main(String[] args) {
		String [] cursos = {"Generacion de Software","Inteligencia Artificial","Robotica"};
		String [] expositor = {"Armando Rioja Perez","Amanda Claribel Trejo","Raul Trejo Arnez"};
		String [] ambiente = {"sala1","sala2","sala1"};
		String [] fecha = {"15/10/2014","16/07/2014","20/10/2014"};
		new retirarCurso(cursos, expositor, ambiente, fecha);
	}
