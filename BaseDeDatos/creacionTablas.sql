...
CREATE TABLE INSCRIPCION (
  ...
  CURSO_idCURSO INTEGER,
  PARTICIPANTE_ciPARTICIPANTE INTEGER,
  fechaInscripcion DATE,
  PRIMARY KEY(OFERTA_idOFERTA, CURSO_idCURSO, PARTICIPANTE_ciPARTICIPANTE),
  FOREIGN KEY(PARTICIPANTE_ciPARTICIPANTE)
    REFERENCES PARTICIPANTE(ciPARTICIPANTE)
      ON DELETE NO ACTION
      ON UPDATE NO ACTION,
